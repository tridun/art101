...
$("#button").click(function(){
  ...
  var gryfText = "To be a Gryffindor is to possess the characteristic traits of courage, chivalry, and determination. Good for you!";
  var huffText = "To be a Hufflepuff is to possess the characteristic traits of dedication, patience, and loyalty!";
  var ravText = "To be a Ravenclaw is to possess the characteristic traits of wit, learning prowess, and wisdom. Way to go smarty!";
  var slyText = "To be a Slytherin means that you must be cunning and ambitious! Be warned however, these traits and this house have spawned many Death Eaters.";
